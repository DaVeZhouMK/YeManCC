...
ws.RegWrite "HKLM\SYSTEM\CurrentControlSet\Control\PriorityControl\ConvertibleSlateMode", 1, "REG_DWORD"
...
Function IsAdmin()
    ...
    On Error Resume Next
    sh.RegWrite "HKLM\SYSTEM\CurrentControlSet\Control\PriorityControl\_yeManAdminTest", 1, "REG_DWORD"
    errNum = Err.Number
