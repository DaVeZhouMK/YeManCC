...
set "YM_RC=0"
rem Apply TDP first; activating the plan can overwrite CPU power settings.
call :run "%~dp0..\pawnio\YeManTdpCtl.exe" set 200
rem Apply Extreme power settings without sound.
