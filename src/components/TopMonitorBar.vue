...
import { startTopMonitor, stopTopMonitor, readTopMonitor, type TopMonData } from '@/bridge/topmon';
...
const data = ref<TopMonData | null>(null);
...
async function poll(): Promise<void> {
  data.value = await readTopMonitor().catch(() => null);
}
