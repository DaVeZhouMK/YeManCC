...
assert.ok(fanHostVerifier.includes('334FB177323FBE8A04306684676211DC822B4F71661823774EB8CCBDD6110D08'));
assert.ok(native.includes('Assert-FanHostV2Payload'));
assert.ok(native.includes('expectedFanHostV2ManifestFileCount = 102'));
